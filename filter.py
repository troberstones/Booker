...
REPLACEMENTS: dict[str, str] = {
    ...
    "sh!t":         "crud",
    "bullshit":     "nonsense",
    "bullshitting": "bluffing",
    "bullshitter":  "blowhard",
    "bullshitters": "blowhards",
    # A-word family
    "ass":          "rear",
    "asses":        "rears",
    "asshole":      "jerk",
    ...
    # Multi-word phrases first (matched before their component words)
    "for the love of god":  "for the love of goodness",
    "for god's sake":       "for goodness' sake",
    "for christ's sake":    "for goodness' sake",
    "jesus h. christ":      "good heavens",
    "jesus h christ":       "good heavens",
    "jesus christ":         "good heavens",
    "god almighty":         "goodness gracious",
    "oh my god":            "oh my goodness",
    "oh my lord":           "oh my goodness",
    "sweet jesus":          "sweet mercy",
    "holy jesus":           "good heavens",
